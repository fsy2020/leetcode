...
//
//<div><div>Related Topics</div><div><li>哈希表</li><li>字符串</li><li>排序</li></div></div><br><div><li>👍 899</li><li>👎 0</li></div>	
...
class Solution242 {
    public boolean isAnagram(String s, String t) {
        ...
        for (int i = 0; i < t.length(); i++){
            hashSet2.add(t.charAt(i));
        }
        boolean a = hashSet1.containsAll(hashSet2);
        boolean b = hashSet2.containsAll(hashSet1);
        return a && b;
